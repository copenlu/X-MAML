...
class XnliProcessor(DataProcessor):
  ...
  def get_train_examples(self, data_dir):
    ...
    for (i, line) in enumerate(lines):
      if i == 0:
        continue
      guid = "train-%d" % (i)
      text_a = convert_to_unicode(line[5])
      text_b = convert_to_unicode(line[6])
      label = convert_to_unicode(line[0])
      domain=convert_to_unicode(line[9])
  ...
  def get_dev_examples(self, data_dir, subset):
    ...
    for (i, line) in enumerate(lines):
      ...
      domain= tokenization.convert_to_unicode(line[10])
...
class MnliProcessor(DataProcessor):
  ...
  def get_test_examples(self, data_dir):
    """See base class."""
    return self._create_examples(
        self._read_tsv(os.path.join(data_dir, "multinli_0.9_test_matched_unlabeled.txt")), "test")
  ...
  def _create_examples(self, lines, set_type):
    ...
    for (i, line) in enumerate(lines):
      ...
      domain = tokenization.convert_to_unicode(line[9])
      # @todo: find ground truth for test data
      if set_type == "test":
        label = "contradiction"
      else:
